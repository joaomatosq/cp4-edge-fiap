...
const char* default_SSID = "Wokwi-GUEST"; // Utilizar Wokwi-GUEST
const char* default_PASSWORD = ""; // Deixar sem nenhuma senha
const char* default_BROKER_MQTT = "20.168.3.60"; // IP do Broker MQTT(VM utilizada)
